...
class NeopixelEngine:
    ...
    def show_level(self, level:int) -> None:
        ...
        if level == 1:
            self.pix.set_pixel(4, apply_strength(lvl1, self.strength))
            self.pix.set_pixel(3, (0, 0, 0))
            self.pix.set_pixel(2, (0, 0, 0))
            self.pix.set_pixel(1, (0, 0, 0))
            self.pix.set_pixel(0, (0, 0, 0))
            self.pix.show()
        elif level == 2:
            self.pix.set_pixel(4, apply_strength(lvl1, self.strength))
            self.pix.set_pixel(3, apply_strength(lvl2, self.strength))
            self.pix.set_pixel(2, (0, 0, 0))
            self.pix.set_pixel(1, (0, 0, 0))
            self.pix.set_pixel(0, (0, 0, 0))
            self.pix.show()
            ...
            self.pix.set_pixel(3, apply_strength(lvl2, self.strength))
            self.pix.set_pixel(2, apply_strength(lvl3, self.strength))
            self.pix.set_pixel(1, apply_strength(lvl4, self.strength))
            self.pix.set_pixel(0, (0, 0, 0))
            self.pix.show()
        elif level == 5:
            self.pix.set_pixel(4, apply_strength(lvl1, self.strength))
            ...
            self.pix.set_pixel(2, apply_strength(lvl3, self.strength))
            self.pix.set_pixel(1, apply_strength(lvl4, self.strength))
            self.pix.set_pixel(0, apply_strength(lvl5, self.strength))
            self.pix.show()
        else:
